    ...
    return (
        ...
        <button id='add-toast' className='active-btn' onClick={clickedButtonFirst}>
            <p>Activity Completed</p>
              ...
              {/* Toast */}
              <div id="toast-success" className="hidden flex items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
